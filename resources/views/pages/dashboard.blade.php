    ...
    @hasrole('admin')
        <div class="w-full grid md:grid-cols-3 max-md:grid-cols-1 md:gap-5 max-md:space-y-4 font-poppins text-slate-700">
            <div class="col-span-1 shadow-lg rounded-lg bg-white p-5 min-h-40">
                <h2 class="md:text-xl max-md:text-lg uppercase font-bold mb-11">Jumlah Santri</h2>
            ...
            <div class="col-span-1 shadow-lg rounded-lg bg-white p-5 min-h-40">
                <h2 class="md:text-xl max-md:text-lg uppercase font-bold mb-11">Jumlah Guru</h2>
                <section class="flex items-end justify-end space-x-2">
            ...
            <div class="col-span-1 shadow-lg rounded-lg bg-white p-5 min-h-40">
                <h2 class="md:text-xl max-md:text-lg uppercase font-bold mb-11">Jumlah Kelas</h2>
                <section class="flex items-end justify-end space-x-2">
