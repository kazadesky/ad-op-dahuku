...
@section('subtitle')
    <p class="flex items-center space-x-px capitalize text-white">
        ...
        @hasrole('teacher')
            <span>Teacher</span>
        @endhasrole
        <span>/ Page / Absensi Guru / Edit</span>
    </p>
@endsection
                ...
                <div class="flex max-md:flex-col max-md:space-y-1 md:space-x-4 md:items-center">
                    ...
                    <select name="teacher_id" id="teacher_id"
                        ...
                        @foreach ($teachers as $teacher)
                            <option value="{{ $teacher->id }}" {{ $teacher->id === $presence->teacher_id ? 'selected' : '' }}>
                                {{ $teacher->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="flex max-md:flex-col max-md:space-y-1 md:space-x-4 md:items-center">
                    ...
                    <select name="lesson_id" id="lesson_id"
                        ...
                        @foreach ($lessons as $lesson)
                            <option value="{{ $lesson->id }}" {{ $lesson->id === $presence->lesson_id ? 'selected' : '' }}>
                                {{ $lesson->name }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <section class="w-full mb-4">
                <div class="flex max-md:flex-col max-md:space-y-1 md:space-x-4 md:items-center">
                    ...
                    <select name="day_id" id="day_id"
                        ...
                        @foreach ($days as $day)
                            <option value="{{ $day->id }}" {{ $day->id === $presence->day_id ? 'selected' : '' }}>
                                {{ $day->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="flex max-md:flex-col max-md:space-y-1 md:space-x-4 md:items-center">
                    ...
                    <select name="time_id" id="time_id"
                        ...
                        @foreach ($times as $time)
                            <option value="{{ $time->id }}" {{ $time->id === $presence->time_id ? 'selected' : '' }}>
                                {{ $time->start }} - {{ $time->finish }}</option>
                        @endforeach
                    </select>
                </div>
                @error('time_id')
            ...
            <section class="w-full mb-4">
                <div class="flex max-md:flex-col max-md:space-y-1 md:space-x-4 md:items-center">
                    ...
                    <select name="substitute_teacher_id" id="substitute_teacher_id"
                        ...
                        @foreach ($teachers as $teacher)
                            <option
                                value="{{ $teacher->id }} {{ $teacher->id === $presence->substitute_teacher_id ? 'selected' : '' }}">
                                {{ $teacher->name }}</option>
                        @endforeach
                    </select>
                </div>
                    ...
                    <select name="teacher_id" id="teacher_id"
                        ...
                        @foreach ($teachers as $teacher)
                            <option value="{{ $teacher->id }}"
                                {{ $teacher->id === $presence->teacher_id ? 'selected' : '' }}>
                                {{ $teacher->name }}</option>
                        @endforeach
                    </select>
                </div>
